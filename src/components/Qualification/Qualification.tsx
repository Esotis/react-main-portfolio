        ...
        <div className="qualification-sections">
          ...
          >
            <div className="qualification-data">
              <div>
                <h3 className="qualification-title">Learning Basic Things</h3>
            ...
            <div className="qualification-data">
              <div>
                ...
                <span className="qualification-subtitle">Youtube - Web</span>
                <div className="qualification-calender">
          ...
          >
            <div className="qualification-data">
              <div>
                <h3 className="qualification-title">Cloning Public Design</h3>
                <span className="qualification-subtitle">Youtube - Figma</span>
                <div className="qualification-calender">
                  <i className="uil uil-calendar-alt"></i> September 2022 -
                  Present
                </div>
            ...
            <div className="qualification-data">
              ...
              <div>
                <h3 className="qualification-title">Make Simple E-Commerce</h3>
